// src/app/features/migration/strategies/item-import.strategy.ts
import { Injectable, inject } from '@angular/core';
import { Timestamp } from '@angular/fire/firestore';
import { firstValueFrom } from 'rxjs'; // Import firstValueFrom
import { IImportStrategy, CsvRow } from '../import-strategy.interface';
import { Item, ItemCategory, UnitType } from '../../items/models/item.model';
import { ItemService } from '../../items/services/item.service';

// Import services and models for lookup
import { PartnerService } from '../../partners/services/partner.service';
import { VehicleCategoryService } from '../../vehicle-categories/services/vehicle-category.service';
